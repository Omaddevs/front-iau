                    ...
                    <div className="admissions-hero-content">
                         <AdmissionsBreadcrumbs
                              items={[
                                   ...
                                   { label: t("admissions.pages.mscSustainable"), current: true },
                              ]}
                         />
                         ...
                         <div className="tab-content-box">
                              {activeTab === "courseContent" && (
                                   <div className="content-pane fade-in">
                                        ...
                                        <p style={{whiteSpace:"pre-line"}}>{t("adm.courseMscSust")}</p>
                                   </div>
                              )}
                              ...
                              {activeTab === "modules" && (
                                   <div className="content-pane fade-in">
                                        ...
                                        <p style={{whiteSpace:"pre-line"}}>{t("adm.mscSustCareers")}</p>
                                   </div>
                              )}
                              ...
                              {activeTab === "entryRequirements" && (
                                   <div className="content-pane fade-in">
                                        ...
                                        <p style={{whiteSpace:"pre-line"}}>{t("adm.mscSustEntry")}</p>
                                   </div>
                              )}
