          ...
          <div className="admissions-page">
               ...
               <div className="admissions-hero">
                    ...
                    <div className="admissions-hero-content">
                         ...
                         <h1>BSc (Hons) Food Safety Management</h1>
                    </div>
               </div>
                              ...
                              {activeTab === "entryRequirements" && (
                                   <div className="content-pane fade-in">
                                        ...
                                        <p>
                                             ...
                                             1. IELTS Academic (UKVI version) min. overall 6.0 with no element below 5.0 or the equivalent of either:<br></br><br></br>
                                             ...
                                             2. 104 UCAS Tariff points or the equivalent of either:<br></br><br></br>
