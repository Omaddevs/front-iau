               ...
               <div className="admissions-hero">
                    ...
                    <div className="admissions-hero-content">
                         <AdmissionsBreadcrumbs
                              items={[{ label: t("admissions.pages.preFoundation"), current: true }]}
                         />
                         <h1>{t("admissions.pages.preFoundation")}</h1>
                    </div>
               </div>
                         ...
                         <div className="tab-content-box">
                              ...
                              {activeTab === "entryRequirements" && (
                                   <div className="content-pane fade-in">
                                        ...
                                        <p style={{whiteSpace:"pre-line"}}>{t("adm.preFound3")}</p>
                                   </div>
                              )}
                              ...
                              {activeTab === "fees" && (
                                   <div className="content-pane fade-in">
                                        ...
                                        <p style={{whiteSpace:"pre-line"}}>{t("adm.preFoundFees")}</p>
                                        <p>{t("admissionsExtra.tabScholarships")}</p>
                                        <p>{t("adm.preFoundSchol")}</p>
                                   </div>
                              )}
                         </div>
